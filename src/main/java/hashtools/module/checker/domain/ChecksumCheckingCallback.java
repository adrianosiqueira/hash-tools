...
public class ChecksumCheckingCallback {
    ...
    public ChecksumCheckingCallback() {
    ...
    public void sendResult(ChecksumCheckingResult result) {
    ...
    public void addResultConsumer(Consumer<ChecksumCheckingResult> consumer) {
        Objects.requireNonNull(consumer);
