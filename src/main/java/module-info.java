module hash.tools {
    ...
    exports hash_tools.backend.checksum_extractor;
    exports hash_tools.backend.checksum_source;
    ...
    opens hash_tools.backend.checksum_extractor;
    opens hash_tools.backend.checksum_source;
